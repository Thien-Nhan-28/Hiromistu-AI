...
public class TestAStartAdmissibleH {
	public static void main(String[] args) {
		...
		NodeUtils.printPath(res);
		
		System.out.println("Admissible H: " + aStar.isAdmissible(s, g1.getLabel()) + "\n");
		
		res = aStar.execute(s, h.getLabel(), g1.getLabel());
		NodeUtils.printPath(res);
	}
}
